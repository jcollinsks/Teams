...
.\Deploy-AzureResourceGroup.ps1 `
    ...
    -ResourceGroupName TeamsProvisioningCT `
    -TemplateParametersFile ct-prov.prod.parameters.json

# Ensure storage queues are in place
$storageAccount = Get-AzureRmStorageAccount | Where-Object ResourceGroupName -eq "TeamsProvisioningCT"
